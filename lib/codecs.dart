...
abstract class TransitEncoder<S, T> extends Converter<S, T> {
  ...
  startChunkedConversion(sink) => _me.startChunkedConversion(sink) as Sink<S>;
...
class MsgPackTransitCodec extends Codec<dynamic, List<int>> {
  ...
  final decoder = new MsgPackTransitDecoder<List<int>, dynamic>();
}
...
class JsonTransitCodec extends Codec<dynamic, String> {
  ...
  final decoder = new JsonTransitDecoder<String, dynamic>();
}
...
class VerboseJsonTransitCodec extends Codec<dynamic, String> {
  ...
  final decoder = new VerboseJsonTransitDecoder<String, dynamic>();
}
