...
final Map<String, ReadHandler> _standardReadHandlers = {
  ...
  "n": (o) {
    ...
    if (o is String) return BigInt.parse(o);
    return null;
  },
  "d": (o) {
  ...
  "m": (o) {
    ...
    if (o is String)
      return new DateTime.fromMillisecondsSinceEpoch(int.parse(o));
    return null;
  },
  "t": (o) {
  ...
  "link": (o) {
    try {
      TransitLink l = new TransitLink(o["href"], o["rel"], o["name"]);
      if (o.containsKey("render"))
        l.render = TransitLinkRenderType.ALL[o["render"]];
      if (o.containsKey("prompt")) l.prompt = o["prompt"];
      return l;
    } catch (e) {
      return null;
    }
