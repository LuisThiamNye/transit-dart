...
class _BigIntWriteHandler extends WriteHandler<BigInt> {
  const _BigIntWriteHandler();

  String tag(BigInt n) => "n";

  rep(BigInt n) => n.toString();

  String string_rep(BigInt n) => n.toString();
}
...
class WriteHandlers extends Object {
  ...
  WriteHandler resolve(Object? o) {
    ...
    for (h in data.values) if (h._handles(o)) return h;
  ...
  static final Map<Type, WriteHandler> _BUILTINS = {
    ...
    BigInt: const _BigIntWriteHandler(),
